...
func init() {
	...
	routers = append(routers, notMatchTestInfo(abcHtml, "/suffix.html/abc"), matchTestInfo("/suffix/abc", abcHtml, nil), matchTestInfo("/suffix/*", abcHtml, nil), notMatchTestInfo("/suffix/*", "/suffix.html/a"))
	const abcSuffix = "/abc/suffix/*"
	routers = append(routers, notMatchTestInfo(abcSuffix, "/abc/suffix.html/a"), matchTestInfo(abcSuffix, "/abc/suffix/a", nil), notMatchTestInfo(abcSuffix, "/abc.j/suffix/a"))
